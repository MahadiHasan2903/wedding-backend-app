...
exports.ConversationModule = ConversationModule = __decorate([
    (0, common_1.Module)({
        imports: [users_module_1.UsersModule, (0, common_1.forwardRef)(() => message_module_1.MessageModule)],
        controllers: [conversation_controller_1.ConversationController],
        providers: [conversation_service_1.ConversationService, conversation_repository_1.ConversationRepository],
        exports: [conversation_service_1.ConversationService, conversation_repository_1.ConversationRepository],
    })
], ConversationModule);
